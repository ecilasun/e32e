...
resize_pblock [get_pblocks pblock_HART0] -add {SLICE_X84Y75:SLICE_X123Y99}
resize_pblock [get_pblocks pblock_HART0] -add {DSP48_X5Y30:DSP48_X6Y39}
resize_pblock [get_pblocks pblock_HART0] -add {RAMB18_X5Y30:RAMB18_X6Y39}
resize_pblock [get_pblocks pblock_HART0] -add {RAMB36_X5Y15:RAMB36_X6Y19}
create_pblock pblock_FPU
add_cells_to_pblock [get_pblocks pblock_FPU] [get_cells -quiet [list HART0/FPU]]
resize_pblock [get_pblocks pblock_FPU] -add {CLOCKREGION_X1Y0:CLOCKREGION_X1Y0}
create_pblock pblock_HART1
add_cells_to_pblock [get_pblocks pblock_HART1] [get_cells -quiet [list HART1]]
resize_pblock [get_pblocks pblock_HART1] -add {SLICE_X84Y100:SLICE_X123Y124}
resize_pblock [get_pblocks pblock_HART1] -add {DSP48_X5Y40:DSP48_X6Y49}
resize_pblock [get_pblocks pblock_HART1] -add {RAMB18_X5Y40:RAMB18_X6Y49}
resize_pblock [get_pblocks pblock_HART1] -add {RAMB36_X5Y20:RAMB36_X6Y24}
create_pblock pblock_HART2
add_cells_to_pblock [get_pblocks pblock_HART2] [get_cells -quiet [list HART2]]
resize_pblock [get_pblocks pblock_HART2] -add {SLICE_X46Y100:SLICE_X83Y124}
resize_pblock [get_pblocks pblock_HART2] -add {DSP48_X3Y40:DSP48_X4Y49}
resize_pblock [get_pblocks pblock_HART2] -add {RAMB18_X3Y40:RAMB18_X4Y49}
resize_pblock [get_pblocks pblock_HART2] -add {RAMB36_X3Y20:RAMB36_X4Y24}
create_pblock pblock_HART3
add_cells_to_pblock [get_pblocks pblock_HART3] [get_cells -quiet [list HART3]]
resize_pblock [get_pblocks pblock_HART3] -add {SLICE_X46Y75:SLICE_X83Y99}
resize_pblock [get_pblocks pblock_HART3] -add {DSP48_X3Y30:DSP48_X4Y39}
resize_pblock [get_pblocks pblock_HART3] -add {RAMB18_X3Y30:RAMB18_X4Y39}
resize_pblock [get_pblocks pblock_HART3] -add {RAMB36_X3Y15:RAMB36_X4Y19}
create_pblock pblock_HART4
add_cells_to_pblock [get_pblocks pblock_HART4] [get_cells -quiet [list HART4]]
resize_pblock [get_pblocks pblock_HART4] -add {SLICE_X46Y50:SLICE_X83Y74}
resize_pblock [get_pblocks pblock_HART4] -add {DSP48_X3Y20:DSP48_X4Y29}
resize_pblock [get_pblocks pblock_HART4] -add {RAMB18_X3Y20:RAMB18_X4Y29}
resize_pblock [get_pblocks pblock_HART4] -add {RAMB36_X3Y10:RAMB36_X4Y14}

create_pblock pblock_GPU
add_cells_to_pblock [get_pblocks pblock_GPU] [get_cells -quiet [list UCDEVICECHAIN/GPU]]
resize_pblock [get_pblocks pblock_GPU] -add {SLICE_X8Y0:SLICE_X23Y99}
resize_pblock [get_pblocks pblock_GPU] -add {DSP48_X0Y0:DSP48_X1Y39}
resize_pblock [get_pblocks pblock_GPU] -add {RAMB18_X0Y0:RAMB18_X1Y39}
resize_pblock [get_pblocks pblock_GPU] -add {RAMB36_X0Y0:RAMB36_X1Y19}


create_pblock pblock_HART5
add_cells_to_pblock [get_pblocks pblock_HART5] [get_cells -quiet [list HART5]]
resize_pblock [get_pblocks pblock_HART5] -add {SLICE_X84Y50:SLICE_X123Y74}
resize_pblock [get_pblocks pblock_HART5] -add {DSP48_X5Y20:DSP48_X6Y29}
resize_pblock [get_pblocks pblock_HART5] -add {RAMB18_X5Y20:RAMB18_X6Y29}
resize_pblock [get_pblocks pblock_HART5] -add {RAMB36_X5Y10:RAMB36_X6Y14}
